...
const DEGEN = getAddress("0x4ed4E862860beD51a9570b96d89aF5E1B0Efefed");
const BRETT = getAddress("0x532f27101965dd16442E59d40670FaF5eBB142E4");
...
const defaultPairs: Pair[] = [
  ...
  { name: "DEGEN/USDC", tokenA: USDC, tokenB: DEGEN, decimalsA: 6 },
  { name: "BRETT/USDC", tokenA: USDC, tokenB: BRETT, decimalsA: 6 },
  ...
  { name: "DEGEN/WETH", tokenA: WETH, tokenB: DEGEN, decimalsA: 18 },
  { name: "BRETT/WETH", tokenA: WETH, tokenB: BRETT, decimalsA: 18 },
];
...
export const config = {
  ...
  execute: booleanFromEnv("EXECUTE"),
  executorAddress: (process.env.EXECUTOR_ADDRESS ?? null) as Address | null,
  privateKey: (process.env.PRIVATE_KEY ?? null) as `0x${string}` | null,
